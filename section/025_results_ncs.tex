...
FlexGen's aggressive offloading degrades by $+6.4\%$ once capacity saturation sets in.
...
In both cases the ($R_C$, $R_B$) classifier correctly identifies the operating
regime, confirming that the two-ratio framework applies to scientific computing
workloads characterised by large spatial or sequence tensors.
