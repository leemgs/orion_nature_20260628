...
\subsection{Energy efficiency as a regime-dependent outcome}
Energy efficiency emerges as a consequential implication of regime-dependent behavior. Within coordination-dominated regimes, effective orchestration reduces idle compute cycles, redundant transfers, and unnecessary synchronization, leading to improved throughput per unit of energy consumed. Outside these regimes, coordination overhead can increase energy cost per operation without improving latency or throughput.
